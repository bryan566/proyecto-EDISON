...
const SearchHistory = (props) => {
  ...
  function openModal2(conten) {
    const getReceta = () => {
      var config = {
        method: "get",
        url: `https://y802ko2n3c.execute-api.us-east-2.amazonaws.com/dev/historial/getRecetaMedicamento?recetaId=${conten[0].recetaId}`,
        headers: {},
      };
  ...
  function mostrarModalReceta(e) {
    function una() {
      var config = {
        method: "get",
        url: `https://y802ko2n3c.execute-api.us-east-2.amazonaws.com/dev/historial/getHistorian?citaId=${e.citaId}`,
        headers: {},
      };
  ...
  const mostrarModalActualizar = (dato) => {
    ...
    function una() {
      var config = {
        method: "get",
        url: `https://y802ko2n3c.execute-api.us-east-2.amazonaws.com/dev/historial/getHistorian?citaId=${dato.citaId}`,
        headers: {},
      };
  ...
  async function getSearchHistory() {
    const response = await axios.get(
      `https://y802ko2n3c.execute-api.us-east-2.amazonaws.com/dev/historial/getHistoriaClisn?identificacion=${search}`
    );
