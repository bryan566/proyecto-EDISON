...
class CitaMedico extends React.Component {
  ...
  getAllExamenes() {
    ...
    axios
      .get(
        `https://y802ko2n3c.execute-api.us-east-2.amazonaws.com/dev/citas/getExamenMedico`
      )
      .then((response) => {
  ...
  getAllMedicaments() {
    axios
      .get(
        `https://y802ko2n3c.execute-api.us-east-2.amazonaws.com/dev/citas/todoMedicament`
      )
      .then((response) => {
  ...
  getDiagnostico = (diagnostico, form, medicamento, examenes, estadoCons) => {
    ...
    */
    ...
    var config = {
      method: "post",
      url: "https://y802ko2n3c.execute-api.us-east-2.amazonaws.com/dev/citas/saveDiagnostico",
      headers: {
    ...
    const stateAtention = () => {
      ...
      var config = {
        method: "post",
        url: "https://y802ko2n3c.execute-api.us-east-2.amazonaws.com/dev/citas/updateStateRequest",
        headers: {
          "Content-Type": "application/json",
        },
        data: data,
    ...
    const receta = () => {
      ...
      var config = {
        method: "post",
        url: "https://y802ko2n3c.execute-api.us-east-2.amazonaws.com/dev/citas/saveRecetaMedica",
        headers: {
          "Content-Type": "application/json",
        },
        data: info,
    ...
    const examenMed = () => {
      ...
      var config = {
        method: "post",
        url: "https://y802ko2n3c.execute-api.us-east-2.amazonaws.com/dev/citas/saveExamen",
        headers: {
          "Content-Type": "application/json",
        },
        data: data,
